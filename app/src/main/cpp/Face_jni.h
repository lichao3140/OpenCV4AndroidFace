 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_com_lichao_opencv4androidface_uitls_JNIUtils_testReadFile
        (JNIEnv *, jclass, jstring);
 ...
 * Signature: ([Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring Java_com_lichao_opencv4androidface_uitls_JNIUtils_doFaceSwap
        (JNIEnv *, jclass, jobjectArray);
